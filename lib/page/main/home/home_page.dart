              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    Row(
                      children:const [
                        Text("Daily Transaction", style: TextStyle(
                          fontSize: 20,
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center,
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: const [
                        Text("5.000.000 đ", style: TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                        ),
                    ...
                    Row(
                        ...
                        children:List.generate(days.length, (index){
                          return GestureDetector(
                            ...
                            child: Container(                            width: (size.width-40)/7,
                              child: Column(
                                children:[
